...
def insert_tweet(connection,tweet):
    ...
    with connection.begin() as trans:
        ...
        sql = sqlalchemy.sql.text('''
        INSERT INTO users (id_users, created_at, updated_at, id_urls, frirends_count, listed_count, favourites_count, statuses_count,
        protected, verified, screen_name, name, location, description, withheld_in_countries)
        VALUE (:id_users, :created_at, :updated_at, :id_urls, :friends_count, :listed_count, :favourites_count, :statuses_count, :protected,
        ...
        connection.execute(sql, {
            ...
            'withheld_in_countries':remove_nulls(withheld_in_countries)
        })
        ########################################
        ...
        connection.execute(sql, {
            'id_tweets':tweet['id'], 'id_urls':id_urls
        })
